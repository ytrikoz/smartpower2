...
#define MCURSES_LINES 24
#define MCURSES_COLS 80
...
void getnstr(char *str,
             uint8_t maxlen); // read a string (with mini editor functionality)
