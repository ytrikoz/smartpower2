...
{
    setupSTA(hostIP(), IPAddress(IP_ADDR_ANY), IPAddress(IP_ADDR_ANY), IPAddress(IP_ADDR_ANY));
...
{
    startSTA(ssid, passwd, IPAddress(IP_ADDR_ANY), IPAddress(IP_ADDR_ANY), IPAddress(IP_ADDR_ANY), IPAddress(IP_ADDR_ANY));
}
